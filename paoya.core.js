...
var ShareManager = /** @class */ (function () {
    ...
    ShareManager.share = function (title, image, query, success, fail) {
        ...
        py.aldShareAppMessage(this.makeShareInfo(title, image, query, function (res) {
...
"
                ...
                "share_img": [
                    "remote/game/share/1019_2.png",
                    "remote/game/share/1019_1.png"
                ],
                "id": 1019,
                "jsonconfig": {
                    "match_info": {
            ...
            "common_config": {
                "share_info": [
                    {
                        "img": "wxremote/game/qrcode/hitmouse.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/da_di_shu.sk",
                        "appId": "wx17e66e26685ed5d0",
                        "game_id": 1004
                    },
                    {
                        "img": "wxremote/game/qrcode/petgo.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/men_chong.sk",
                        "appId": "wx28a78997b4784ef1",
                        "game_id": 1005
                    },
                    {
                        "img": "wxremote/game/qrcode/food.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/mei_shi_jia.sk",
                        "appId": "wx405ee3ea1e491440",
                        "game_id": 1006
                    },
                    {
                        "img": "wxremote/game/qrcode/reversi.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/fan_fan_le.sk",
                        "appId": "wx786d0c5f03d1c2fc",
                        "game_id": 1007
                    },
                    {
                        "img": "wxremote/game/qrcode/xiaoxl.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/xiao_xiao_le.sk",
                        "appId": "wx1fa0ca658a9a0ce6",
                        "game_id": 1008
                    },
                    {
                        "img": "wxremote/game/qrcode/jump.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/tiao_yi_tiao.sk",
                        "appId": "wxff74aa65beb1ba7e",
                        "game_id": 1009
                    },
                    {
                        "img": "wxremote/game/qrcode/onlyme.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/bi_wu_chang.sk",
                        "appId": "wxcaae4fff0e46aead",
                        "game_id": 1011
                    },
                    {
                        "img": "wxremote/game/qrcode/coupling.png",
                        "spine_url": "https://res.xingqiu123.com/wxremote/game/intro/chai_san_qing_lv.sk",
                        "appId": "wxa163f2723eef4ea3",
                        "game_id": 1012
                    }
                ],
                "hall_img": "wxremote/game/qrcode/hall.png"
            },
            "item_list": [
                {
                    "pao_gold": 100,
...
var Toast = /** @class */ (function () {
    ...
    */
    ...
    Toast.showSuccess = function (title, duration) {
        if (duration === void 0) { duration = 1500; }
        this.show(title, null, 'https://res.xingqiu123.com/wxremote/game/common/success.png', duration);
    };
    Toast.showError = function (title, duration) {
        if (duration === void 0) { duration = 1500; }
        this.show(title, null, 'https://res.xingqiu123.com/wxremote/game/common/error.png', duration);
    };
    Toast.showWarn = function (title, duration) {
        if (duration === void 0) { duration = 1500; }
        this.show(title, null, 'https://res.xingqiu123.com/wxremote/game/common/warning.png', duration);
    };
...
var LaunchScreenView = /** @class */ (function (_super) {
    ...
    LaunchScreenView.prototype.setup = function () {
        ...
        imgProgressBg.sizeGrid='4,4,4,4';
        imgProgressBg.centerX = 0;
        imgProgressBg.bottom = 250;
        imgProgressBg.width=643;
        imgProgressBg.height=36;
        box.addChild(imgProgressBg);

        var imgProgress = new Laya.Image('local/loading/progress-bar.png');
        imgProgress.centerX = 0;
        imgProgress.y=2;
        imgProgressBg.addChild(imgProgress);

        var imgProgressTag = new Laya.Image('local/loading/progress-tag.png');
        imgProgressTag.anchorX=0.5;
        imgProgressTag.y=-24;
        imgProgressBg.addChild(imgProgressTag);
        this.imgProgressTag=imgProgressTag;
        ...
        lblProgress.bottom = 190;
        this.addChild(lblProgress);
        this._lblProgress = lblProgress;

        var lblTips = new Laya.Label('幸存者会加入你的队伍，请务必营救他们！');
        lblTips.color = '#ccc';
        lblTips.fontSize = 28;
        lblTips.centerX = 0;
        lblTips.bottom = 50;
    ...
    Object.defineProperty(LaunchScreenView.prototype, "progress", {
        ...
        set: function (newValue) {
            if (newValue != this._progress) {
                ...
                this.imgProgressTag.x=newValue * this._imgProgress.width;
            }
        },
        enumerable: true,
        configurable: true
